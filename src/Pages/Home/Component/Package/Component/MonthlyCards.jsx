            ...
            <div className="flex gap-15 mt-15">
                <div className="">
                    <div className="border border-gray-200 rounded-3xl py-8 px-10 flex flex-col gap-5 w-105">
                        ...
                        <div className="bg-base-300 p-4 rounded-xl">
                            <p className='text-4xl font-bold text-center'>$19.99<span className='text-sm'>/per month</span></p>
                        </div>
                ...
                <div className="">
                    <div className="border border-gray-200 rounded-3xl py-8 px-10 flex flex-col gap-5 w-105 bg-[#1B4B36] text-white">
                        ...
                        <div className="bg-[#FCDE70] text-black p-4 rounded-xl">
                            <p className='text-4xl font-bold text-center'>$249.99<span className='text-sm'>/per month</span></p>
                        </div>
                        <div className="flex flex-col gap-4">
                ...
                <div className="">
                    <div className="border border-gray-200 rounded-3xl py-8 px-10 flex flex-col gap-5 w-105">
                        ...
                        <div className="bg-base-300 p-4 rounded-xl">
                            <p className='text-4xl font-bold text-center'>$299.99<span className='text-sm'>/per month</span></p>
                        </div>
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-3 text-gray-500">
                                <div className="bg-[#1B4B36] rounded-full p-0.5">
