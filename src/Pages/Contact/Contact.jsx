...
const Contact = () => {
    return (
        <div>
            <div className="">
                <div className="">
                    <PageHeader name={"Contact Us"} image={"https://demo.awaikenthemes.com/lineman/wp-content/uploads/2025/02/service-image-5.jpg"}></PageHeader>
                    <div className="flex justify-start items-start mb-15 gap-10 w-8/12 mx-auto">
                        <div className="bg-[#F5F7F8] w-7/12 p-15 text-justify rounded-3xl">
                            <div className="grid gap-2 border-b border-gray-300 pb-8">
                                <SubHeader name={"CONTACT US"} color={"text-[#1B4B36]"}></SubHeader>
                                <Header beforeBr={"Contact us & let's"} afterBr={""} yellowText={"collaborate!"}></Header>
                            ...
                            <div className="mt-10">
                                ...
                                <div className="mt-10">
                                    <Button name={"Sent Your Message"}></Button>
                                </div>
                            </div>
                        </div>
